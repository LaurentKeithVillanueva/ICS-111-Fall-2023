public class ICS111Assignment08 {
    public static void main(String[] args){
        ...
        //When using this passenger list, everyone gets added to a flight.
        //The first six passengers will be added to flight 473
        //and the next two will automatically be added to flight 474
        //String[] passenger = {"Alice","Bob","Cynthia","Derick","Elmo","Francis","George","Helen"};
        ...
        String[] passenger = {"Alice","Bob","Cynthia","Derick","Elmo","Francis","George","Helen","Irene","James","Kelly","Laurie","Mary"};

        //Add all of the passengers to the flights.
        for (String p : passenger) { // Iterate through the passengers
        ...
        if(f2.addPassenger(passenger[2])){
            ...
            System.out.println(passenger[2] + " could not be booked on flight " +
            f2.getFlightNumber());
            System.out.println(f1.getPassengerManifest());
            System.out.println(f2.getPassengerManifest());
        }
